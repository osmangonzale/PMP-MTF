...
//        ['underline', '{$lang_underline_img}', 'lang_underline_desc', 'Underline'],
        ['bold', 'bold.svg', 'lang_bold_desc', 'Bold'],
        ['italic', 'italic.svg', 'lang_italic_desc', 'Italic'],
        ['underline', 'underline.svg', 'lang_underline_desc', 'Underline'],
        ['strikethrough', 'strikethrough.svg', 'lang_striketrough_desc', 'Strikethrough'],
        ['justifyleft', 'align-left.svg', 'lang_justifyleft_desc', 'JustifyLeft'],
        ['justifycenter', 'align-center.svg', 'lang_justifycenter_desc', 'JustifyCenter'],
        ['justifyright', 'align-right.svg', 'lang_justifyright_desc', 'JustifyRight'],
        ['justifyfull', 'align-justify.svg', 'lang_justifyfull_desc', 'JustifyFull'],
        ['bullist', 'list-ul.svg', 'lang_bullist_desc', 'InsertUnorderedList'],
        ['numlist', 'list-ol.svg', 'lang_numlist_desc', 'InsertOrderedList'],
        ['outdent', 'outdent.svg', 'lang_outdent_desc', 'Outdent'],
        ['indent', 'indent.svg', 'lang_indent_desc', 'Indent'],
        ['cut', 'cut.svg', 'lang_cut_desc', 'Cut'],
        ['copy', 'copy.svg', 'lang_copy_desc', 'Copy'],
        ['paste', 'paste.svg', 'lang_paste_desc', 'Paste'],
        ['undo', 'undo.svg', 'lang_undo_desc', 'Undo'],
        ['redo', 'redo.svg', 'lang_redo_desc', 'Redo'],
        ['link', 'link.svg', 'lang_link_desc', 'mceLink', true],
        ['unlink', 'unlink.svg', 'lang_unlink_desc', 'unlink'],
        ['image', 'image.svg', 'lang_image_desc', 'mceImage', true],
//        ['cleanup', 'brush.svg', 'lang_cleanup_desc', 'mceCleanup'],
        ['help', 'question.svg', 'lang_help_desc', 'mceHelp'],
        ['code', 'code.svg', 'lang_theme_code_desc', 'mceCodeEditor'],
        //['hr', 'hr.gif', 'lang_theme_hr_desc', 'inserthorizontalrule'],
//        ['removeformat', 'removeformat.gif', 'lang_theme_removeformat_desc', 'removeformat'],
        ['sub', 'subscript.svg', 'lang_theme_sub_desc', 'subscript'],
        ['sup', 'superscript.svg', 'lang_theme_sup_desc', 'superscript'],
        ['forecolor', 'fill-drip.svg', 'lang_theme_forecolor_desc', 'forecolor', true],
        ['backcolor', 'paint-roller.svg', 'lang_theme_backcolor_desc', 'HiliteColor', true],
//        ['charmap', 'charmap.gif', 'lang_theme_charmap_desc', 'mceCharMap'],
        //['visualaid', 'visualaid.gif', 'lang_theme_visualaid_desc', 'mceToggleVisualAid'],
        ['anchor', 'anchor.svg', 'lang_theme_anchor_desc', 'mceInsertAnchor'],
        ['newdocument', 'file.svg', 'lang_newdocument_desc', 'mceNewDocument']
    ],
    _buttonMap: 'anchor,backcolor,bold,bullist,code,copy,cut,forecolor,help,image,indent,italic,justifycenter,justifyfull,justifyleft,justifyright,link,newdocument,numlist,outdent,paste,redo,strikethrough,sub,sup,underline,undo,unlink,advhr,ltr,rtl,emotions,fullpage,fullscreen,iespell,insertdate,inserttime,selectall,preview,print,save,replace,search,table,cell_props,delete_col,delete_row,col_after,col_before,row_after,row_before,merge_cells,row_props,split_cells,delete_table',
    /**
    ...
    getControlHTML: function (button_name) {
        ...
        switch (button_name) {
            ...
            case "fontselect":
                var fontHTML = '<select id="{$editor_id}_fontNameSelect" name="{$editor_id}_fontNameSelect" onfocus="tinyMCE.addSelectAccessibility(event, this, window);" onchange="tinyMCE.execInstanceCommand(\'{$editor_id}\',\'FontName\',false,this.options[this.selectedIndex].value);" class="mceSelectList"><option value="" style="display:none">Fuente &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &#9660;</option><option value="">Normal</option>';
            ...
            case "fontsizeselect":
                return '<select id="{$editor_id}_fontSizeSelect" name="{$editor_id}_fontSizeSelect" onfocus="tinyMCE.addSelectAccessibility(event, this, window);" onchange="tinyMCE.execInstanceCommand(\'{$editor_id}\',\'FontSize\',false,this.options[this.selectedIndex].value);" class="mceSelectList" style="width:auto">' +
                        '<option value="0" style="display:none">Tama&ntilde;o &#9660;</option>' +
...
//                    theme_advanced_buttons3: "hr,removeformat,visualaid,separator,sub,sup,separator,charmap"
                    theme_advanced_buttons1: "fontselect,fontsizeselect,bold,italic,underline,strikethrough,separator,justifyleft,justifycenter,justifyright,justifyfull,separator,bullist,numlist,separator,outdent,indent,separator,link,unlink,anchor,image,cleanup,code,hr,removeformat,visualaid,separator,sub,sup,separator,charmap",
                ...
                for (var i = 1; i < 100; i++) {
                    ...
                    if (buttons.length > i) {
                        toolbarHTML += "<hr style='margin:0px'/>";
                        deltaHeight -= 23;
                    }
                }

...
var Validate = {
    ...
    Enteros3: function (value, paramsObj) {
        var paramsObj = paramsObj || {};
        var message = paramsObj.failureMessage || "";
        Validate.Format(value, {
            failureMessage: message,
    ...
    Decimal_total: function (value, paramsObj) {
        var paramsObj = paramsObj || {};
        var message = paramsObj.failureMessage || "";
        Validate.Format(value, {
            failureMessage: message,
            pattern: /^[0-9]{1,9}(\.[0-9]{1,5}){0,1}?$/i
        });
        return true;
    },
    DecimalNA: function (value, paramsObj) {
        var paramsObj = paramsObj || {};
        var message = paramsObj.failureMessage || "";
        if (value == "N/A") {
            Validate.Format(value, {
    ...
    Materiales: function (value, paramsObj) {
        ...
        if (value.length <= 6) {
            Validate.Format(value, {
                failureMessage: message,
                pattern: /^([0-9]{3,6}){1,1}$/i
            });
        } else {
            Validate.Format(value, {
                failureMessage: message,
                pattern: /^([0-9]{3,6}(\-[0-9]{3,6}){1,20})$/i
            });
        }
        return true;
    },
    LoteC: function (value, paramsObj) {
        ...
        if (value == "N/A") {
            ...
            Validate.Format(value, {
                failureMessage: message,
                pattern: /^[0-9]{1,5}(\E)?[-][0-9]{1,2}[A-L]{1,1}([0][1-9]|[1-2][0-9]|[3][0-1])$/i
            });
        }
        return true;
    },
    LoteP: function (value, paramsObj) {
        ...
        if (value == "N/A") {
            ...
            Validate.Format(value, {
                failureMessage: message,
                pattern: /^[0-9]{1,5}(\E)?[-][0-9]{1,2}[A-L]{1,1}([0][1-9]|[1-2][0-9]|[3][0-1])[-][0-9]{1,2}$/i
            });
        }
        return true;
    },
